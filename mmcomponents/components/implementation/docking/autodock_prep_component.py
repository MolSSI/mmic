from mmcomponents.models.components.docking.autodock.input import AutoDockSimInput
...
from mmcomponents.components.blueprints.docking.docking_prep_component import DockPrepComponent
